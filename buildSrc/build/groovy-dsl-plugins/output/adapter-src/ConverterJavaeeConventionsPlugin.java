...
/**
 * Precompiled converter.javaee-conventions script plugin.
 **/
public class ConverterJavaeeConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        assertSupportedByCurrentGradleVersion();
                target.getPluginManager().apply("converter.java-library-conventions");

        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ConverterJavaeeConventions").asSubclass(BasicScript.class);
